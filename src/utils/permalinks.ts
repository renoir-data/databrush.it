...
export const DOCS_BASE = cleanSlug(APP_DOCS?.pathname);

export const DOCS_PERMALINK_PATTERN = trimSlash(`${DOCS_BASE}/%id%`);
...
/** */
export const getBlogPermalink = (): string => definitivePermalink(createPath(BLOG_BASE));
